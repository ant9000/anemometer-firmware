...
#define	CH101_GPR_SR_TEXT_SIZE	CH101_FW_SIZE

const uint16_t  ch101_gpr_sr_text_size	= CH101_GPR_SR_TEXT_SIZE;

const unsigned char ch101_gpr_sr_fw_text[CH101_GPR_SR_TEXT_SIZE] = {
